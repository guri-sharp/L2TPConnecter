...
namespace VPNClient
{
    public partial class SettingForm : Form
    {
        ...
        {
            authenticationMethodComboBox.DataSource = "Pap,Chap,MSChapv2,Eap,MachineCertificate".Split(',');
            ...
            authenticationMethodComboBox.DataBindings.Add(nameof(authenticationMethodComboBox.SelectedItem), Settings, nameof(Settings.AuthenticationMethod));
        }
